...
if __name__ == "__main__":
    root_directory = Path('ENTIRE_GAME_DUMP_PRELIMINARY_DAWNTRAIL_UP_TO_6_3')  # Replace with your root directory path
    clean_directory_structure(root_directory, max_workers=8)
    print("Directory cleaned, preserving only .tex files")
